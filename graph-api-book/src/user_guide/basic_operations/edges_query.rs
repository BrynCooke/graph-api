use graph_api_lib::{Graph, EdgeSearch, VertexSearch};
...
fn main() {
    ...
    fn all_edges_example(graph: &impl Graph<Vertex = Vertex, Edge = Edge>) {
        ...
        if let Some(person_id) = bryn_id {
            ...
            let connected_edges = graph.walk()
